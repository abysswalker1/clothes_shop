...
import {setSpecificCategoryThunk, getSearchedProductsThunk, getSearchedResultsAction, setPriceRangeAction} from "../../../store/productsReducer";
import ProductsList from "../../products-list/productsList";
import productsListSelector from "../../../selectors/productsListSelector";
import { MainStateType, SpecificCategoryType, ProductType, SearchQueryParams } from '../../../types';
...
const Catalog: React.FC<Props> = (props) => {
    ...
    useEffect(() => {
      let neededCategory = props.specificCategories.filter(
        (item) => item[0] === title
      );
...
export default compose(
    connect(mapStateToProps, { setSpecificCategoryThunk, getSearchedProductsThunk, getSearchedResultsAction, setPriceRangeAction }),
)(Catalog);